...
Looking at a count of the records by year reveals that the first and last year of the data does not include a full year of data. As this is hourly data, a full year of data should have 365*24 = 8,760 records (8,784 records on leap year).
```{r, warning=F, message=F, results='hide', fig.width = 8, fig.height = 5}
